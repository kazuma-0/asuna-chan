...
def animeSearch(title):
    ...
    if variables:
        ...
        embed = discord.Embed(
            colour=discord.Colour.from_rgb(26, 26, 255),
            title=(
                "{} ({}) {}".format(
...
def userAnime(result):
    ...
    embedAni = discord.Embed(colour=discord.Colour.from_rgb(26, 26, 255))
...
def userManga(result):
    ...
    embedMan = discord.Embed(colour=discord.Colour.from_rgb(26, 26, 255))
